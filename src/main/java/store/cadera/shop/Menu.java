...
final class Menu implements InventoryHolder {
    enum Kind { SHOPS, BUY, QUANTITY, BUY_CONFIRM, SELL, EDIT_SHOPS, EDIT_ITEMS, EDIT_PRICE }
    final Kind kind;
    final UUID owner;
    final String shop;
    final Integer npc;
    ...
    Menu(Kind kind, UUID owner, String shop, Integer npc, int page, long expires, String title) {
        this.kind = kind; this.owner = owner; this.shop = shop; this.npc = npc; this.page = page; this.expires = expires;
